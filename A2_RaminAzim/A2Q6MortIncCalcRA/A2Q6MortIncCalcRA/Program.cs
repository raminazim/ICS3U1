...
namespace A2Q6MortIncCalcRA
{
    internal class Program
    {
        static void Main(string[] args)
        {
            // Declaration
            string strUserInput;
            double dblHousePrice, dblDownPayment, dblLoanAmount, dblRate, dblMonthlyPayment, dblNumerator, dblDenominator;
            int intPaymentPerYear, intYear, intTotalPayments;
            double dblNetMonthly, dblGrossMonthly, dblGrossAnnual;
